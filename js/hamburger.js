const hamburgerBottton = document.querySelector("#btn-hamburger"); //DIV
const hamburgerPanel = document.querySelector("#panel"); //DIV
const btnPanel1 = document.querySelector("#btn-panel-1");
...
btnPanel1.onclick = function menuHamburguer() {
    hamburgerPanel.classList.toggle("is-active");    //AL ELEMENTO hamburguerPanel SE LE AGREGARA O QUITARA LA CLASE 
}
btnPanel2.onclick = function menuHamburguer() {
    hamburgerPanel.classList.toggle("is-active");    //AL ELEMENTO hamburguerPanel SE LE AGREGARA O QUITARA LA CLASE 
}
btnPanel3.onclick = function menuHamburguer() {
    hamburgerPanel.classList.toggle("is-active");    //AL ELEMENTO hamburguerPanel SE LE AGREGARA O QUITARA LA CLASE 
}
